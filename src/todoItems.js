export const todoItems = [
    ...
    culpa qui officia deserunt mollit anim id est laborum.`, dueDate: '2024-10-20' }, // 12 days away (primary)
    ...
    Vivamus nec nisi nec nunc mattis molestie. Sed auctor nunc nec nisi ultrices, in molestie nibh mattis.`, dueDate: '2024-10-15' }, // 7 days away (success)
    ...
    senectus et netus et malesuada fames ac turpis egestas.`, dueDate: '2024-10-10' }, // 2 days away (warning)
    ...
    Nullam nec nibh nibh. Nullam quis nisl nec nunc congue mollis. `, dueDate: '2024-10-05' }, // Overdue (danger)
];
